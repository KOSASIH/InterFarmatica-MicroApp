...
public class CacheConfiguration {
        ...
        if (this.registration == null) { // if registry is not defined, use native discovery
            ...
            return () ->
                GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-InterFarmatica-cluster")
                    .jmx()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream
                .of(
                    com.kosasih.interfarmatica.repository.UserRepository.USERS_BY_LOGIN_CACHE,
                    com.kosasih.interfarmatica.repository.UserRepository.USERS_BY_EMAIL_CACHE
                )
                .forEach(cacheName ->
                    manager.defineConfiguration(
                        cacheName,
